...
Scenario: User creates and amends a CHEDA notification, inspector requests amendment, and processes with multiple emergency lab tests - SPS-7388
	...
	And the user clicks Save and continue
	Then What is the main reason for importing the animals? page should be displayed with radio buttons
	When the user chooses 'Internal market' and the sub-option 'Restocking'
	And the user clicks Save and continue
	Then the Notification Hub page should be displayed
	When the user clicks the Commodity hyperlink
	Then the Commodity page should be displayed with the commodity and description entered
	...
	Then What is the main reason for importing the animals? page should be displayed with radio buttons
	When the user changes the main reason for importing to 'Internal market' and the sub-option 'Research'
	And the user clicks on Save and return to hub
	Then the Notification Hub page should be displayed
	...
	Then the Additional animal details page should be displayed
	When the user changes What are the animals certified for? to 'Breeding and/or production'
	And the user clicks on Save and return to hub
	Then the Notification Hub page should be displayed
	When the user clicks on 'Transport to the BCP or Port of entry' link
	Then the Transport to the BCP or Port of entry page should be displayed
	When the user changes Are any road trailers or shipping containers being used to transport the consignment to 'Yes'
	And the user enters Container Number 'CONT987654'
	And the user enters Seal Number 'SEAL123456'
	And the user ticks the checkbox to confirm an official seal is affixed
	And the user changes means of transport to BCP or Port of entry to 'Airplane'
	And the user changes the estimated arrival time at BCP to '23:00'
	And the user changes transport identification to 'RV999'
	And the user changes the estimated total journey time of the animals to '15' hours
	And the user clicks on Save and return to hub
	Then the Notification Hub page should be displayed
	When the user clicks on 'Transport after the BCP or Port of entry' link
	Then the Transport after the BCP or Port of entry page should be displayed
	When the user selects means of transport after BCP 'Road vehicle'
	And the user enters transport identification after BCP 'TRANS999'
	...
	When the user clicks on 'Origin of the import' link
	Then the Origin of the import page should be displayed
	When the user changes the Country of origin to 'Singapore'
	And the user clicks on Save and return to hub
	Then the Notification Hub page should be displayed
	When the user clicks on 'Review and submit' link
	Then the Review your notification page should be displayed
...
Scenario: User creates and submits a CHEDA notification, copies it as new and verifies copied values - SPS-7389
	...
	And the user clicks Save and continue
	Then the Origin of the import page should be displayed, showing 'Thailand' as the Country of origin and Country from where consigned
	And the Does your consignment require a region code? defaults to 'No'
	When the user clicks Save and continue
	Then the Description of the goods/Commodity page should be displayed
	When the user searches '0103' commodity code
	Then the commodity details should be populated '0103' 'Live swine'
	...
	When the user enters BCP or Port of entry 'London Borough of Hillingdon Heathrow Airport Imported Food Office - ADADA'
	And the user selects means of transport to BCP or Port of entry 'Airplane'
	And the user enters transport identification 'BA123'
	And the user selects 'No' for Are any road trailers or shipping containers being used to transport the consignment
	And the user enters transport document reference 'Doc1234'
	And the user enters arrival date at BCP or Port of entry as today's date
	And the user enters estimated arrival time at BCP with future time
	...
	And the Commodity code and Description should be copied from the original notification
	When the user populates Number of animals as '3'
	And the user populates Number of packages as '2'
	And the user clicks on Save and return to hub on the Commodity page
	Then the Notification Hub page should be displayed
	...
	When the user clicks on 'Transporter' link
	Then the Transporter page should be displayed
	And the Transporter should not be copied from the original notification
	When the user clicks Add a transporter
	Then the Search for an existing transporter page should be displayed
	When the user selects any one of the displayed transporters
	Then the chosen transporter should be displayed on the Transporter page
...
Scenario: User creates and submits a CHEDA notification with laboratory tests changed from Yes to No - SPS-7390
	...
	And the user clicks Save and continue in commodity page
	Then the Enter animal identification details page should be displayed
	And Number of animals should be displayed as '5' in the animal identification details page
	When the user populates the Ear tag as 'ET1234'
	And the user clicks Save and continue
	Then the Additional animal details page should be displayed
	When the user selects 'Approved bodies' for What are the animals certified for?
	...
	When the user Clicks the change link under 'Laboratory tests'
	Then the Laboratory tests page should be displayed
	When the user selects 'No' radio button for Would you like to record laboratory tests?
	And the user clicks Save and continue
	Then the Decision page should be displayed
	When the user clicks Save and continue
	Then the Select a controlled destination page should be displayed
	...
	Then the Review outcome decision page should be displayed
	And the details reflect the information added
	And the Laboratory test details are not displayed in the review page
	When the user selects the radio button to declare that the checks have been carried out in accordance with EU law
	And user clicks Submit decision
	Then the Your checks have been submitted page should be displayed
	When the user clicks View or print CHED
...
Scenario: User creates and submits a CHEDA consignment notification with EU country, multiple species and permanent addresses for animals - SPS-7363
	...
	And the user clicks Save and continue
	Then the Description of the goods/Commodity page should be displayed
	When the user searches '01061900' commodity code
	Then the commodity details should be populated '01061900' 'Other'
	When the user selects species of commodity 'Canis familiaris'
	And the user selects species of commodity 'Equus quagga'
	And the user selects species of commodity 'Equus spp.'
	And the user selects species of commodity 'Felis catus'
	And the user clicks Save and continue
	Then What is the main reason for importing the animals? page should be displayed with radio buttons
	When the user chooses 'Internal market' and the sub-option 'Transfer of ownership – Rescue'
	And the user clicks Save and continue
	Then the Notification Hub page should be displayed
	When the user clicks the Commodity hyperlink
	Then the Commodity page should be displayed with the commodity and description entered
	When the user populates Number of animals as '2' for the commodity 'Canis familiaris'
	And the user populates Number of animals as '2' for the commodity 'Equus quagga'
	And the user populates Number of animals as '2' for the commodity 'Equus spp.'
	And the user populates Number of animals as '2' for the commodity 'Felis catus'
	And the user populates Number of packages as '1' for the commodity 'Canis familiaris'
	And the user populates Number of packages as '1' for the commodity 'Equus quagga'
	And the user populates Number of packages as '1' for the commodity 'Equus spp.'
	And the user populates Number of packages as '1' for the commodity 'Felis catus'
	And the user clicks Save and continue in commodity page
	Then the Enter animal identification details page should be displayed
	When the user populates the Microchip number as 'MC-CF-001' for the species 'Canis familiaris' animal 1
	And the user populates the Passport number as 'PP-CF-001' for the species 'Canis familiaris' animal 1
	And the user populates the Tattoo as 'TT-CF-001' for the species 'Canis familiaris' animal 1
	And the user clicks Add another for the species 'Canis familiaris'
	And the user populates the Microchip number as 'MC-CF-002' for the species 'Canis familiaris' animal 2
	And the user populates the Passport number as 'PP-CF-002' for the species 'Canis familiaris' animal 2
	And the user populates the Tattoo as 'TT-CF-002' for the species 'Canis familiaris' animal 2
	And the user populates the Microchip number as 'MC-EQ-001' for the species 'Equus quagga' animal 1
	And the user populates the Passport number as 'PP-EQ-001' for the species 'Equus quagga' animal 1
	And the user populates the Tattoo as 'TT-EQ-001' for the species 'Equus quagga' animal 1
	And the user clicks Add another for the species 'Equus quagga'
	And the user populates the Microchip number as 'MC-EQ-002' for the species 'Equus quagga' animal 2
	And the user populates the Passport number as 'PP-EQ-002' for the species 'Equus quagga' animal 2
	And the user populates the Tattoo as 'TT-EQ-002' for the species 'Equus quagga' animal 2
	And the user populates the Microchip number as 'MC-ES-001' for the species 'Equus spp.' animal 1
	And the user populates the Passport number as 'PP-ES-001' for the species 'Equus spp.' animal 1
	And the user populates the Tattoo as 'TT-ES-001' for the species 'Equus spp.' animal 1
	And the user clicks Add another for the species 'Equus spp.'
	And the user populates the Microchip number as 'MC-ES-002' for the species 'Equus spp.' animal 2
	And the user populates the Passport number as 'PP-ES-002' for the species 'Equus spp.' animal 2
	And the user populates the Tattoo as 'TT-ES-002' for the species 'Equus spp.' animal 2
	And the user populates the Microchip number as 'MC-FC-001' for the species 'Felis catus' animal 1
	And the user populates the Passport number as 'PP-FC-001' for the species 'Felis catus' animal 1
	And the user populates the Tattoo as 'TT-FC-001' for the species 'Felis catus' animal 1
	And the user clicks Add another for the species 'Felis catus'
	And the user populates the Microchip number as 'MC-FC-002' for the species 'Felis catus' animal 2
	And the user populates the Passport number as 'PP-FC-002' for the species 'Felis catus' animal 2
	And the user populates the Tattoo as 'TT-FC-002' for the species 'Felis catus' animal 2
	And the user clicks Save and continue
	Then the Additional animal details page should be displayed
	When the user selects 'Approved bodies' for What are the animals certified for?
	And the user clicks Save and continue
	...
	When the user selects 'A different address' for each animal
	And the user enters the permanent address details for the commodity 'Canis familiaris' 1
	And the user enters the permanent address details for the commodity 'Canis familiaris' 2
	And the user enters the permanent address details for the commodity 'Equus quagga' 1
	And the user enters the permanent address details for the commodity 'Equus quagga' 2
	And the user enters the permanent address details for the commodity 'Equus spp.' 1
	And the user enters the permanent address details for the commodity 'Equus spp.' 2
...
Scenario: User creates and submits a notification, override the risk decision, reject the notification and creates record control - CHEDA - SPS-7392
	...
	And the sub commodity list expands
	And the user selects the '010420' 'Goats' under the parent commodity
	...
	Then the Additional animal details page should be displayed
	When the user selects 'Approved bodies' for What are the animals certified for?
	And the user keeps the "No" option selected for Does the consignment contain any unweaned animals?	
	And the user clicks Save and continue
	Then the Latest Health Certificate page should be displayed
	When the user enters Latest Health Certificate Document reference 'VHC12345'
	And the user enters Latest Health Certificate date of issue '01''12''2025'
	...
	And the user enters transport identification after BCP 'TRANS123'
	And the user enters transport document reference after BCP 'TDOC456'
	And the user enters departure date from BCP or Port of entry as today's date
	...
	And the user selects '25' '%' for Number of dead animals
	And the user selects '3' 'unit' for Number of unfit animals
	And the user selects '1' for Number of births or abortions
	And the user clicks Save and continue
	Then the Seal numbers page should be displayed
	And 'No' is pre-selected for Are new seal numbers required?
	When the user clicks Save and continue
	...
	And the user clicks Save and continue
	Then the Laboratory tests Reason for testing page should be displayed
	And 'Random' is pre-selected for Reason for testing
	And the user clicks Save and continue
	Then the Laboratory tests Select the commodity sampled page should be displayed
	And the Laboratory tests screen is displayed with the correct Commodity code
	And the Laboratory tests screen is displayed with the correct Description
	And the Laboratory tests screen is displayed with the correct Species
	And the Laboratory tests screen is displayed with the Select hyperlink for the commodity sampled
	When the user clicks the Select link for the '010420' commodity code
	Then the Laboratory tests Commodity to be tested page should be displayed
	When the user selects 'Animal diseases' in Laboratory test category
	...
	And the user selects a future date from the date picker for the Released date
	And the user enters "Test" in Laoratory test method textbox
	And the user enters "Test" in Results textbox
	When the user selects 'Not satisfactory' for Conclusion
	And the user clicks Save and continue
	Then the Laboratory tests Review page should be displayed
	And the user verifies the data and the conclusion as "Not satisfactory" on the Laboratory Tests Review page
	When the user clicks Save and continue
	Then the Decision page should be displayed
	And 'Internal market' radio is pre-selected under Acceptable for
	When the user changes the selection to "Re-dispatching" "Not acceptable" in the decision page
	And the user selects a future date using the date picker for By date
	When the user clicks Save and continue
	Then the Reason for Refusal page should be displayed
	When the user selects "Diseased Or Suspect Animals" as reason for refusal
	And the user selects "Unfit To Travel" as another reason for refusal
	And the user clicks Save and continue
	Then the Review outcome decision page should be displayed
	And the details reflect the information added
	When the user selects the radio button to declare that the checks have been carried out in accordance with EU law
	...
	And the user selects Date of departure using date picker
	And the user selects 'Heathrow Airport - HARC (animals) - GBLHR4A' as Exit BCP
