...
Scenario: SPS-9104
	...
	#And the 'Identity & Physical Check' Charge records have been created
	#And the 'Document Check' Charge records have been created
	#When I click IPAFFS from the header ribbon
	#And I switch to the IPAFFS tab
	#Then the CHED overview page should be displayed
