...
{
    public class CommodityRulesForCHEDAPage : ICommodityRulesForCHEDAPage
    {
        private readonly IObjectContainer _objectContainer;
        private IWebDriver _driver => _objectContainer.Resolve<IWebDriver>();

        #region Page Objects
        private IWebElement pageHeading => _driver.WaitForElement(By.XPath("//h1[normalize-space()='Commodity rules for CHED-A']"), true);
        ...
        public CommodityRulesForCHEDAPage(IObjectContainer container) => _objectContainer = container;

        public bool IsPageLoaded() => pageHeading.Text.Trim().Equals("Commodity rules for CHED-A");
