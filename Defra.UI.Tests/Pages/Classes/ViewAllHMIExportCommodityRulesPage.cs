...
{
    public class ViewAllHMIExportCommodityRulesPage : IViewAllHMIExportCommodityRulesPage
    {
        ...
        [
            "Id", "Commodity", "Variety", "Rate %",
            "Previous rate %", "Permanent", "Start date", "End date"
        ];

        #region Page Objects
        private By pageTitleBy => By.XPath("//h1[normalize-space()='View all HMI (Export) Commodity Rules']");
        ...
        public ViewAllHMIExportCommodityRulesPage(IObjectContainer container)
        {
