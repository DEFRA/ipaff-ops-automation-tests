...
{
    public class ViewAllCHEDDImportCommodityRulesPage : IViewAllCHEDDImportCommodityRulesPage
    {
        ...
        [
            ...
            "Country exceptions", "Purpose", "Border Control Post", "Reason"
        ];

        #region Page Objects
        private IWebElement pageTitle => _driver.WaitForElement(By.XPath("//h1[normalize-space()='View all CHED-D (Import) Commodity Rules']"), true);
        ...
        private IWebElement RemoveRuleLink(string ruleId) => _driver.WaitForElement(By.XPath($"//a[contains(@href,'/Rules/Commodity/CHEDD/Remove?ruleId={ruleId}')]"));
        private By RemoveRuleLinkBy(string ruleId) => By.XPath($"//a[contains(@href,'/Rules/Commodity/CHEDD/Remove?ruleId={ruleId}')]");
        #endregion

        public ViewAllCHEDDImportCommodityRulesPage(IObjectContainer container)
        {
        ...
        {
            return pageTitle.Text.Trim().Equals("View all CHED-D (Import) Commodity Rules");
        }
