...
{
    public class ViewRulesForAllCountriesHMIImportPage : IViewRulesForAllCountriesHMIImportPage
    {
        ...
        public ViewRulesForAllCountriesHMIImportPage(IObjectContainer container)
        {
