...
{
    public class SelectTheCHEDACommodityYouWantToAddARuleForPage : ISelectTheCHEDACommodityYouWantToAddARuleForPage
    {
        private IObjectContainer _objectContainer;
        private IWebDriver _driver => _objectContainer.Resolve<IWebDriver>();

        #region Page Objects
        private IWebElement pageTitle => _driver.WaitForElement(By.XPath("//h1[normalize-space()='Select the CHED-A commodity you want to add a rule for']"), true);
        ...
        public SelectTheCHEDACommodityYouWantToAddARuleForPage(IObjectContainer container)
        {
            _objectContainer = container;
        }

        public bool IsPageLoaded() => pageTitle.Text.Trim().Equals("Select the CHED-A commodity you want to add a rule for");
