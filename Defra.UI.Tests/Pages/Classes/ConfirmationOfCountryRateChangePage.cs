...
{
    public class ConfirmationOfCountryRateChangePage : IConfirmationOfCountryRateChangePage
    {
        private IObjectContainer _objectContainer;
        private IWebDriver _driver => _objectContainer.Resolve<IWebDriver>();

        #region Page Objects
        private IWebElement pageTitle => _driver.WaitForElement(By.XPath("//h1[normalize-space()='Confirmation of country rate change']"), true);
        ...
        public ConfirmationOfCountryRateChangePage(IObjectContainer container)
        {
            _objectContainer = container;
        }

        public bool IsPageLoaded() => pageTitle.Text.Trim().Equals("Confirmation of country rate change");
