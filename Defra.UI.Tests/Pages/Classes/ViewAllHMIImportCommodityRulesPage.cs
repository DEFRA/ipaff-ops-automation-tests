...
{
    public class ViewAllHMIImportCommodityRulesPage : IViewAllHMIImportCommodityRulesPage
    {
        ...
        [
            "Id", "Description", "EPPO", "Commodity code", "Rate %",
            "Previous rate %", "Countries", "Permanent", "Start date", "End date"
        ];

        #region Page Objects
        private By pageTitleBy => By.XPath("//h1[normalize-space()='View all HMI (Import) Commodity Rules']");
        ...
        public ViewAllHMIImportCommodityRulesPage(IObjectContainer container)
        {
