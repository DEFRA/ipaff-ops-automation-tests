namespace Defra.UI.Tests.Contracts
{
    public class Summary
    {
        ...
        public string ContryFromWhereConsigned { get; set; }
        public string ConsignmentConformToRegulatoryRequirements { get; set; }
        public string ConsignmentReferenceNumber { get; set; }
        ...
        public string ApprovedEstablishmentApprovalNum { get; set; }
