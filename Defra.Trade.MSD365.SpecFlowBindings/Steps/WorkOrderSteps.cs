...
public sealed class WorkOrderSteps : PowerAppsStepDefiner
{
    ...
    public void ThenAllTheCommodityLinesShouldBeValidatedWithTheValuesGivenInTheInput()
    {
        ...
        // TODO: Remove this temporary data injection once the full IPAFFS scenario populates AllCommodityDetails in the scenario context.
        // Pattern mirrors ImportNotificationSteps.WhenISearchImporterNotificationsForTheNotificationCreatedInIPAFFS()
        ...
        while (true)
        {
            ...
            var grid = Driver.WaitUntilAvailable(
                ...
                $"Commodity Lines grid could not be found on page {pageNumber}.");
